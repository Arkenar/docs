...
<Card title="POST /api/v1/accounts" href="/api/v1/accounts" method="POST">
...
<Card title="GET /api/v1/accounts/{accountId}" href="/api/v1/accounts/{accountId}" method="GET">
...
<Card title="GET /api/v1/accounts" href="/api/v1/accounts" method="GET">
...
<Card title="PUT /api/v1/accounts/{accountId}" href="/api/v1/accounts/{accountId}" method="PUT">
...
<Card title="DELETE /api/v1/accounts/{accountId}" href="/api/v1/accounts/{accountId}" method="DELETE">
...
<Card title="GET /api/v1/accounts/{accountId}/statements" href="/api/v1/accounts/{accountId}/statements" method="GET">
...
<Card title="PUT /api/v1/accounts/{accountId}/statements/{statementId}" href="/api/v1/accounts/{accountId}/statements/{statementId}" method="PUT">
...
<Card title="POST /api/v1/accounts/{accountId}/statements/batch-review" href="/api/v1/accounts/{accountId}/statements/batch-review" method="POST">
