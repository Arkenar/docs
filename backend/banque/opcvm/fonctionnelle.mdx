...
<Card title="GET /api/v1/opcvm-holdings" href="/api/v1/opcvm-holdings" method="GET">
...
<Card title="GET /api/v1/opcvm-holdings/{holdingId}" href="/api/v1/opcvm-holdings/{holdingId}" method="GET">
...
<Card title="POST /api/v1/opcvm-holdings" href="/api/v1/opcvm-holdings" method="POST">
...
<Card title="PUT /api/v1/opcvm-holdings/{holdingId}" href="/api/v1/opcvm-holdings/{holdingId}" method="PUT">
...
<Card title="DELETE /api/v1/opcvm-holdings/{holdingId}" href="/api/v1/opcvm-holdings/{holdingId}" method="DELETE">
