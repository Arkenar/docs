...
<Card title="GET /api/v1/analytics/accounts/{accountId}/balance-history" href="/api/v1/analytics/accounts/{accountId}/balance-history" method="GET">
...
<Card title="GET /api/v1/analytics/cashflow" href="/api/v1/analytics/cashflow" method="GET">
...
<Card title="GET /api/v1/analytics/consolidated-balance" href="/api/v1/analytics/consolidated-balance" method="GET">
...
<Callout type="warning" title="Comportement en cas de taux de change manquants">
