...
<Card title="GET /api/v1/exchange-rates" href="/api/v1/exchange-rates" method="GET">
...
<Card title="GET /api/v1/exchange-rates/by-date" href="/api/v1/exchange-rates/by-date" method="GET">
...
<Card title="POST /api/v1/exchange-rates" href="/api/v1/exchange-rates" method="POST">
...
<Card title="POST /api/v1/exchange-rates/batch" href="/api/v1/exchange-rates/batch" method="POST">
...
<Card title="DELETE /api/v1/exchange-rates/{id}" href="/api/v1/exchange-rates/{id}" method="DELETE">
